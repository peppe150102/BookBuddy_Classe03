              ...
              <div class="card w-[15rem] h-[23.5rem] relative bg-[#323c66]">
                ...
                <div class="card-button flex flex-col absolute bottom-0 right-0">
                  <% if(session.getAttribute("studente")!=null){%>
                    <a href="${pageContext.request.contextPath}/AggiungiALibreria?id=${MaterialeDidattico.id}"
                    ...
                    <a href="${pageContext.request.contextPath}/AggiungiPreferito?id=${MaterialeDidattico.id}"
